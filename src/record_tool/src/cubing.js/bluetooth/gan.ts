...
import { BareBlockMove, BlockMove } from "./polyfill";
...
export class GanCube extends BluetoothPuzzle {
  ...
  private cachedFaceletStatus1Characteristic: null | Promise<BluetoothRemoteGATTCharacteristic> = null;
  private cachedFaceletStatus2Characteristic: null | Promise<BluetoothRemoteGATTCharacteristic> = null;
  private cachedActualAngleAndBatteryCharacteristic: null | Promise<BluetoothRemoteGATTCharacteristic> = null;
